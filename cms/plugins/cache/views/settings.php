...
<div id="CS" class="box">
	<form id="CSForm" class="form" action="<?php echo get_url('plugin/cache/settings'); ?>" method="post">
		...
		<section>
			...
			<span id="CSType">
				<i class="radio"><input id="CSTypeRadio-static" type="checkbox" value="yes" name="setting[cache_static]" <?php if (isset($setting['cache_static']) && $setting['cache_static'] == 'yes') echo('checked'); ?> /> <label for="CSTypeRadio-static"><?php echo __('Switch On'); ?></label></i>
			</span>
		</section>
